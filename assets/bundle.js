...
$('#email_signup input[type="email"]').on('focus', function () {
	$(this).closest('form').find('.error_message').hide();
});

$('.template-password #email_signup').on('submit', function (event) {
...
$('.section-password .checkbox').on('click', function () {
...
$('.list-lang a').on('click', function (event) {
	event.preventDefault();
...
$('.nav-trigger').on('click', function (event) {
	...
	$this.toggleClass('opened').parent();
...
$('.menu-item-has-children a').on('click', function (event) {
	...
	if (!$this.hasClass('clicked')) {
		...
		$(this).addClass('clicked').parent().addClass('opened').find('>ul').toggleClass('opened');
	}
});
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
$('.section-password .checkbox a').magnificPopup({
	type: 'inline'
});
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
$('.recharge-previous-step a').on('click', function (event) {
	event.preventDefault();
...
$('.recharge-step-3').on('click', function (event) {
	event.preventDefault();
...
$('.recharge-submit').on('click', function (event) {
	var readyToSubmit = rechargeNextSection($(this));
	if (!readyToSubmit) {
		event.preventDefault();
	}
});

function rechargeNextSection($clickedElement) {
	var $radioSelected = $clickedElement.closest('.section-recharge').find('input:checked');

	if ($radioSelected.length != 0) {
		$($clickedElement.attr('href')).addClass('visible').siblings().removeClass('visible');
		return true;
	} else {
		$clickedElement.closest('.section-recharge').find('.error_message').addClass('visible');
		return false;
	}
}
...
$('.accordion__section').each(function () {
	var $this = $(this);
	var $links = $this.find('.list-links');

	if ($this.siblings().length) {
		$this.siblings().find('.accordion__head a').each(function () {
...
$('.accordion__head a').on('click', function (event) {
	...
	if (!$this.hasClass('active')) {
		...
		$this.closest('.accordion__section').toggleClass('is-visible');

		setTimeout(function () {
			$('.section-accordions .section__images').addClass('opened');

			$this.closest('.accordion__section').find('.accordion__content').slideDown();
		}, 500);
	} else {
		$this.closest('.accordion__section').find('.accordion__content').slideUp();

		setTimeout(function () {
			$('.section-accordions .section__images').removeClass('opened');

			$accordion.removeClass('active');
			$this.closest('.accordion__section').removeClass('is-visible');
			$this.removeClass('active');
		}, 500);
	}
});

$(document).on('click', '.accordion__section .list-links a', function (event) {
	event.preventDefault();
	var $link = $(this);
	var elementText = $(this).text();
	var $siblingsLinks = $(this).closest('.accordion__section').siblings().find('.accordion__head a');

	$link.closest('.accordion__content').slideUp();

	setTimeout(function () {
		$link.closest('.accordion__section').removeClass('is-visible');
	}, 500);

	$('.accordion__head a').removeClass('active');

	$siblingsLinks.each(function () {
		var $this = $(this);
		var siblingsText = $this.text();

		if (siblingsText == elementText) {

			setTimeout(function () {
				$this.addClass('active').closest('.accordion__section').addClass('is-visible').find('.accordion__content').slideDown();
			}, 501);
		}
	});
});
